...
Arrows فانکشن کوتاه شده‌ای هستش که بصورت `=>` استفاده میشود. این ویژگی بسیار عالی در سایر زبانهای مانند C#, Java, CaffeeScript مشابهت دارد.
...
با به روزرسانی جاوااسکریپت در ES6 تمام ویژگی های OOP راحت تر نسبت به حالت prototype  قابل توسعه می باشد.
</div>
